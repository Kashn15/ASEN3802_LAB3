...
if Part == 3
    ...
    if Task1 == 1
        ...
        % Convergence Plot - Data Acquisition
        N_exact = 150; % 'Exact' solution we are assuming is a very large # of panels
    ...
    if Task3 == 1
        ...
        mu = 1.716e-5 * (T / 273.15)^(3/2) * ((273.15+S)/(T+S)); % Dynamic Viscosity
        % nu = mu / rho_inf; % Kinematic Viscosity
